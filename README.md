...
* Clone the repository by entering the command `git clone https://github.com/andela-bolajide/ExpressJS-API-Demo` in the terminal.
* Navigate to the project folder using `cd ExpressJS-API-Demo` on your terminal (or command prompt)
